...
public class Driver {
    ...
    ● Herhangi bir Java classinda yalnızca bir obje oluşturmamıza izin veriliyorsa, bu tur classlara singleton class denir.
    Yani singleton pattern(tekli kullanim) bir Class’ı tek bir instance ile kısıtlayan bir software dizayn kalıbıdır.
    ● Genel olarak aynı gereksinimimiz olduğunda, ve buna her ihtiyac duyuldugunda ayrı bir obje oluşturulması tercih edilmez.
    Singleton class; kullanıcıyı Webdriver’ın gerekli olduğu tüm örnekler(instance) için aynı objeyi kullanmaya zorlar.
    ...
    ● Tüm framework’te veya tüm classlarda koordine için tek bir obje gerektiğinde faydalıdır.
                    */
    private Driver() {
    ...
    public static void closeDriver() {
        if (driver != null) {//if the driver is pointing chrome
            ...
            //driver kapatinca degeri de silinsin diye null yaptik..
            // cunku bir baska class icin calistirinca en bastan baslasin..
        }
    }
